...
| **🪪 Report Cards** | Toggle **🎓 By Student** (all classes for one student) or **📋 By Class** (walk the class roster student-by-student, one class at a time). Each card: attendance rate, homework completion, quiz average + detail, and a **teacher comment**. **🖨 Print** or **Export CSV** (all students, or just the selected class). |
