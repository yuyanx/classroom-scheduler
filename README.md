...
- **Quiz sheet template** (first-pass scores in Google Sheets, later import): download [`templates/PremierPlus_Quiz_Sheet_Template.xlsx`](./templates/PremierPlus_Quiz_Sheet_Template.xlsx) — upload to Drive and open with Google Sheets. Long-form CSV sample: [`templates/PremierPlus_Quiz_Import_Long.csv`](./templates/PremierPlus_Quiz_Import_Long.csv).
